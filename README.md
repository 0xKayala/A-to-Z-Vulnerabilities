...
- [Security Misconfiguration](#Security-Misconfiguration)
    ...
    - [Improper Access Controls](#Improper-Access-Controls)
    - [Information Disclosure](#Information-Disclosure)
    - [Unpatched Software](#Unpatched-Software)
    - [Misconfigured CORS](#Misconfigured-CORS)
    - [HTTP Security Headers Misconfiguration](#HTTP-Security-Headers-Misconfiguration)
